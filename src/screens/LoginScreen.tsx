...
export default function LoginScreen() {
  ...
  return (
    <View style={styles.container}>
      ...
      <TextInput style={styles.input} placeholder="Correo" value={values.email} onChangeText={(t) => handleChange('email', t)} />
      <TextInput style={styles.input} placeholder="Contraseña" secureTextEntry value={values.password} onChangeText={(t) => handleChange('password', t)} />
...
const styles = StyleSheet.create({
  ...
  input: { width: '100%', borderWidth: 1, borderColor: '#ccc', borderRadius: 10, padding: 10, marginBottom: 10, backgroundColor: '#fff' },
  button: { backgroundColor: '#2e86de', borderRadius: 10, padding: 12, width: '100%', alignItems: 'center' },
